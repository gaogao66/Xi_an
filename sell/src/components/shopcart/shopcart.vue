  ...
  <div>
    <div class="shopcart">
      ...
      <div class="ball-container">
        <transition-group v-on:after-enter="afterEnter" v-on:enter="enter" v-on:before-enter="beforeEnter" name="drop" tag="div">
    ...
    <pay :totalPrice="totalPrice" :foods="selectFoods"  ref="pays"></pay>
  </div>
</template>
